...
class Participacion(SQLModel, table=True):
    ...
    batalla_id: int | None = Field(foreign_key="batalla.id", primary_key=True)
...
class Tipo(SQLModel, table=True):
    ...
    pokemon: List["Pokemon"] = Relationship(
...
class Batalla(SQLModel, table=True):
    ...
    ganador: Optional["Entrenador"] = Relationship(back_populates="batallas_ganadas")
...
class Entrenador(SQLModel, table=True):
    ...
    batallas_ganadas: List["Batalla"] = Relationship(back_populates="ganador")
...
class Pokemon(SQLModel, table=True):
    ...
    tipos: List["Tipo"] = Relationship(back_populates="pokemon", link_model=PokemonTipo)
